...
public class TweetTopology {
  ...
  public static void main(String[] args) throws Exception {
    ...
    builder.setBolt("stdout", new SentenceSplitBolt(), 1).shuffleGrouping("word", "SplitBolt");
//      builder.setSpout("Entity", new EntitySpout("6MbJh7TnNGPVI7S3m3UJRsy12",
//              "mRnQkEgR0lGa1rqwf6gNEfYTyIrsxlWDa7Rvx4qRpTYMWBY9UE",
//              "86457010-MkTSViBdfPJPZ9OElBlVEkBvKXaH6yvxg8apSpbXa",
//              "Kjbi3EJDh2wP0rLTKJiMg3myFthvRsOrwSbwWFkbCpdYj"), 1);
      builder.setBolt("EntityPrint", new PrinterBolt(),1).shuffleGrouping("word", "SourceBolt");
      builder.setBolt("GeoExtBolt", new GeoExtBolt(),1).shuffleGrouping("word", "GeoBolt");
      ...
      builder.setBolt(HashTagCounter,new HashTagCount(),1).fieldsGrouping(HashTag, new Fields("hashtag"));
